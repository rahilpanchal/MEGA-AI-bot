...
//
global.botname = process.env.BOTNAME || '― ⸙『 𓆩𝐑𝐀𝐇𝐔𝐋 𝐏𝐀𝐍𝐂𝐇𝐀𝐋𓆪』';
global.pairingNumber = process.env.BOT_NUMBER || '917017659124' ;  // put your number here
global.SESSION_ID = process.env.SESSION_ID || 'XB5RVY4Z#_2YLVbHp_fWBuoI-PReQVeSi5e-4lwwJBtTrry1WLfA' ;  // put your session id here
